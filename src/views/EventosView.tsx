...
export default function EventosView({ eventsData, eventsPageData, isLoading = false, error = null }: EventosViewProps) {
  ...
  return (
    <div>
        ...
        }} className={`pt-16 bg-primary bg-cover bg-center bg-no-repeat text-center text-white ${nextEvent ? 'pb-16 lg:pb-40' : 'pb-16'}`}>
            <div className="container mx-auto px-4">
                ...
                {!nextEvent && (
                    <div className='flex flex-col md:flex-row w-full max-w-screen-lg gap-0.5 md:gap-0 justify-center mx-auto mt-10'>
                        <button className={`text-body1 lg:text-h6 lg:text-lg text-text-primary p-3 px-6 md:w-1/3 lg:rounded-tl-lg lg:rounded-bl-lg cursor-pointer transition-colors border-r border-gray-300 ${activeTab === "todos" ? "bg-details-hover text-gray-800" : "bg-white hover:bg-gray-50"}`} onClick={() => handleTabChange("todos")}>Calendario Anual</button>
                        <button className={`text-body1 lg:text-h6 lg:text-lg text-text-primary p-3 px-6 md:w-1/3 cursor-pointer transition-colors border-r border-gray-300 ${activeTab === "proximos" ? "bg-details-hover text-gray-800" : "bg-white hover:bg-gray-50"}`} onClick={() => handleTabChange("proximos")}>Próximos</button>
                        <button className={`text-body1 lg:text-h6 lg:text-lg text-text-primary p-3 px-6 md:w-1/3 lg:rounded-tr-lg lg:rounded-br-lg cursor-pointer transition-colors ${activeTab === "pasados" ? "bg-details-hover text-gray-800" : "bg-white hover:bg-gray-50"}`} onClick={() => handleTabChange("pasados")}>Pasados</button>
                    </div>
                )}
            </div>
        </section>
            ...
            <section className='bg-white lg:py-16 py-10'>
              <div className="container mx-auto px-4 lg:-mt-40 z-10">
                ...
                <CardNextEvent 
                  ...
                  image={nextEvent.featuredImage?.url}
