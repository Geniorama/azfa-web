...
export default function SearchButton({ onClick, className }: SearchButtonProps) {
  return (
     <button onClick={onClick} className={`flex flex-col items-center cursor-pointer bg-text-primary rounded-full p-6 transition relative hover:bg-text-secondary ${className}`}>
